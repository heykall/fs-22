      ...
      <div className="container-fluid mx-lg-5 mt-lg-4">
        ...
        <Navbar.Collapse id="navbarTogglerDemo02">
          <Nav className="me-auto mb-2 mb-lg-0">
            <Nav.Item
              className="nav-item mx-lg-3 text-center fw-semibold"
              id="font-general"
            >
            ...
            <NavDropdown
              ...
              className="text-decoration-none text-dark fw-semibold custom-dropdown"
            >
              <NavDropdown.Item className="text-light link-dark fw-bold">
                Visi dan Misi
              </NavDropdown.Item>
              <NavDropdown.Item className="text-light link-dark fw-bold">
                Tim LiterasiKita
            ...
            >
              <NavDropdown.Item
                href="/halaman-buku"
                className="text-light link-dark fw-semibold"
              >
                BukuPedia
              </NavDropdown.Item>
              <NavDropdown.Item
